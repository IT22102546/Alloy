...
export default function GoogleReviews() {
  ...
  return (
    <section 
      ref={sectionRef} 
      className="py-20 bg-gradient-to-br from-[#0f0f0f] via-[#181818] to-[#1a1a1a] relative overflow-hidden"
    >
      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16 fade-in">
          ...
          <p className="text-[#B0B0B0] max-w-[700px] mx-auto text-lg md:text-xl leading-relaxed">
            Discover what our guests are saying about their exceptional experiences at Alloy Restaurant
          </p>
        </div>
        ...
        <div className="fade-in mb-16">
          <div className="relative group">
            ...
            {!iframeLoaded && (
              <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] rounded-3xl border border-[#B6935B]/20 shadow-2xl">
            ...
            <div className={`relative rounded-3xl overflow-hidden transition-all duration-1000 ${iframeLoaded ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-8'}`}>
              ...
              <iframe
                ...
                className="w-full rounded-3xl border border-[#B6935B]/30 bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] shadow-2xl transition-all duration-500 group-hover:shadow-2xl group-hover:border-[#B6935B]/50 relative z-10"
                title="Alloy Restaurant Google Reviews"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                loading="lazy"
              />
              
              {/* Hover Overlay */}
              <div className="absolute inset-0 bg-gradient-to-t from-[#0f0f0f]/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl pointer-events-none z-20"></div>
            </div>
            ...
            <div className="relative z-10 p-8 md:p-12">
              <div className="flex flex-col items-center justify-center mb-8">
                ...
                <p className="text-[#B0B0B0] text-lg md:text-xl mb-8 max-w-2xl leading-relaxed">
                  Have you dined with us recently? We'd love to hear about your memorable experience at Alloy Restaurant and share it with our community.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                ...
                <a
                  href="#contact"
                  className="group relative border-2 border-[#B6935B] text-[#B6935B] px-8 py-4 rounded-2xl font-semibold transition-all duration-500 hover:bg-[#B6935B] hover:text-[#111] hover:shadow-2xl hover:-translate-y-2 flex items-center justify-center gap-3 min-w-[220px] overflow-hidden"
                >
                  <div className="absolute inset-0 bg-[#B6935B] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left"></div>
