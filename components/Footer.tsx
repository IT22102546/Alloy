  ...
  return (
    <footer className="bg-[#111] py-20 pb-[30px]">
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-[60px]"> {/* Increased gap */}
          {/* Restaurant Info */}
          <div className="space-y-6">
            <h3 className="font-playfair text-2xl mb-6 relative pb-3 after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-12 after:h-[2px] after:bg-gold text-cream">
              Aloy Restaurant
            </h3>
            ...
            <div className="flex gap-4 pt-4">
              {[
                ...
                <a
                  key={index}
                  href={social.href}
                  className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center transition-all duration-300 hover:bg-gold hover:text-[#111] hover:-translate-y-1 text-cream"
                >
          ...
          <div className="space-y-6">
            ...
            <ul className="list-none space-y-4">
              {[
                { icon: 'location', text: 'No.806, Peradeniya Road, Kandy, Sri Lanka', href: '#' },
                { icon: 'phone', text: '+94 81 238 7547', href: '+94812387547' },
                ...
                <li key={index} className="group">
                  <a href={item.href} className="text-cream/80 transition-all duration-300 flex items-center gap-4 hover:text-gold hover:pl-2 py-2">
                    <div className="w-8 h-8 bg-gold/20 rounded-full flex items-center justify-center group-hover:bg-gold group-hover:text-[#111] transition-all duration-300">
                      {item.icon === 'location' && (
                      ...
                      {item.icon === 'globe' && (
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9v-9m0 9v-9m0 0h9m-9 0H3" />
                        </svg>
                      )}
                    </div>
            ...
            <ul className="list-none space-y-4">
              {[
                ...
                <li key={index} className="flex justify-between items-center py-3 border-b border-white/10 last:border-b-0 group hover:bg-white/5 hover:px-3 hover:-mx-3 rounded-lg transition-all duration-300">
                  ...
                  <span className="text-gold font-semibold bg-gold/20 px-3 py-1 rounded-lg border border-gold/30 group-hover:bg-gold group-hover:text-[#111] transition-all duration-300">
                    {schedule.time}
                  </span>
                </li>
              ))}
          ...
          <div className="space-y-6">
            ...
            <ul className="list-none space-y-4">
              {[
                ...
                <li key={index} className="group">
                  <a href={link.href} className="text-cream/80 transition-all duration-300 flex items-center gap-4 hover:text-gold hover:pl-2 py-3">
                    <div className="w-8 h-8 bg-gold/20 rounded-full flex items-center justify-center group-hover:bg-gold group-hover:text-[#111] transition-all duration-300">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center pt-8 border-t border-white/10 text-cream/80 text-base">
          <p>
            &copy; 2025 Aloy Restaurant. All Rights Reserved. | Designed By xyz Company
            <svg className="inline w-5 h-5 text-gold" fill="currentColor" viewBox="0 0 20 20">
